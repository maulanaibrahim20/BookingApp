            ...
            <ul class="side-menu">
                ...
                @if (Auth::check())
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide"
                            href="
                            @if (Auth::user()->role_id == 1) {{ url('/admin') }}
                            @elseif(Auth::user()->role_id == 2){{ url('/mua') }}
                            @elseif(Auth::user()->role_id == 3){{ url('/client') }} @endif">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);"><i
                            class="side-menu__icon ti ti-user"></i><span class="side-menu__label">User</span><i
                            class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Pages</a></li>
                        <li><a href="{{ url('/admin/client') }}" class="slide-item"> Profile</a></li>
                    </ul>
                </li>
                <li class="sub-category">
                    <h3>Make Up</h3>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ url('/admin') }}"><i
                            class="side-menu__icon fe fe-alert-circle"></i><span class="side-menu__label">MUA</span></a>
                </li>
            </ul>

...
<body>
    ...
    <main>
        ...
        <a href="" class="btn btn-primary"><i class="fa fa-arrow-left">Kembali</i></a>
        <a href="{{ url('/mua/booking/view_invoice/cetak_invoice/' . $booking->id_booking) }}"
            class="btn btn-primary"><i class="fa fa-print">Cetak PDF</i></a>
